...
This version includes the message_length parameter in the decode_message_from_image function, limiting the decoding process to the specified message length.
'''
...
def decode_message_from_image(image_file, message_length):
...
decoded_message = decode_message_from_image(output_path, len(message))
